...
function generatePassword() {
  ...
  charactersNumber = prompt(
    "Please, enter your password. Choose between 8 and 64 characters."
  );
  ...
  considerNumericCharacters = confirm(
    "Click OK if you consider to include numbers?"
  );
  ...
  considerSpecialCharacters = confirm(
  ...
  if (
    considerLowercase === false &&
    considerUppercase === false &&
    considerNumericCharacters === false &&
    considerSpecialCharacters === false
  ) {
